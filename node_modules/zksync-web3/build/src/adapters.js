...
function AdapterL1(Base) {
    return class Adapter extends Base {
        ...
        async getBaseCost(params) {
            ...
            (_b = parameters.gasPerPubdataByte) !== null && _b !== void 0 ? _b : (parameters.gasPerPubdataByte = utils_1.DEPOSIT_GAS_PER_PUBDATA_LIMIT);
        ...
        async deposit(transaction) {
            ...
            (_d = tx.gasPerPubdataByte) !== null && _d !== void 0 ? _d : (tx.gasPerPubdataByte = utils_1.DEPOSIT_GAS_PER_PUBDATA_LIMIT);
        ...
        async requestExecute(transaction) {
            ...
            (_e = tx.gasPerPubdataByte) !== null && _e !== void 0 ? _e : (tx.gasPerPubdataByte = utils_1.DEPOSIT_GAS_PER_PUBDATA_LIMIT);
            ...
            await (0, utils_1.checkBaseCost)(baseCost, overrides.value);
            return this._providerL2().getPriorityOpResponse(await zksyncContract.requestL2Transaction(contractAddress, l2Value, calldata, l2GasLimit, utils_1.DEPOSIT_GAS_PER_PUBDATA_LIMIT, factoryDeps, refundRecipient, overrides));
        }
    };
}
